...
files_pi = glob.glob(os.path.join('..', 'high_n_data', 'sn_rates', 'pisn*'))
files_pi.sort()
i_file = 0
n_file = len(files_pi)
...
plt.savefig('../plots/work/CCSN_angle.jpg', bbox_inches='tight')
plt.show()
plt.clf()
...
plt.savefig('../plots/work/PISN_angle.jpg', bbox_inches='tight')
plt.show()
plt.clf()
