...
print 'reading data'
files = glob.glob(os.path.join('..', 'high_n_data', 'z_MBH_*'))
i_file = 0
n_file = len(files)
...
plt.plot(z[0, :], mbh_arr, label=('UXBR Limit'), color='black', linestyle='-')
...
plt.savefig('../plots/reproduced/mbh.jpg', bbox_inches='tight')
plt.show()
plt.clf()
